...
This repository provides introductory Python scripts designed to help beginners learn the fundamentals of Python programming. The focus is on understanding imports, exploring basic standard libraries, and producing simple console output.
...
sys for accessing Python runtime information
matplotlib for basic data visualization
The script shows:

Generating a random number
Performing math operations like square roots and factorials
...
Understand what import statements are and why they are used
...
Notes
All examples are simple, clear, and beginner-friendly.
No advanced Python concepts are used.
The repository reflects only the examples covered so far in lessons and may expand over time.
